...
$title = 'Data Pegawai | Admin SIKAMU';
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
		...
		<div class="float-right">
			<a href="<?= base_url()?>tambah_pegawai.php" class="btn btn-success btn-sm">
					...
					while($d = mysqli_fetch_array($data)){
						...
						<tr>
							...
							<td class="text-center">
								<a href="edit_pegawai.php?id=<?= $d['id']?>" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit">
...
<script>
	...
	function hapus(id){
		if(confirm('Hapus?')) window.location = 'hapus_pegawai.php?id='+id;
	}
</script>
